...
class ImportScripts::MyAskBot < ImportScripts::Base
  ...
  CATEGORIES = []
=begin 'Atmosphere', 'Agave_API', 'Bisque', 'BUSCO', 'CoGe', 'cuffdiff', 'cuffdiff2', 'Cufflinks2', 'Cuffmerge', 'DataStore', 'DiscoveryEnvironment', 'DNASubway', 'FoundationAPI', 'General', 'HPC', 'HTProcess', 'icommands', 'idrop', 'iplant.UK', 'Metadata', 'PoweredByiPlant', 'rna-seq', 'SSWAP', 'TNRS', 'tophat', 'Trimming', 'trinity', 'VNC' ]
=end
  def initialize
    super
